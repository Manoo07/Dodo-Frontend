      ...
      >
        ...
        {dueDate && (
          isCompleted || isWontDo ? (
            ...
            <span className="shrink-0 mx-2 inline-flex items-center gap-1.5 px-0.75 py-0.5 rounded-lg text-[11.5px] font-semibold text-priority-p1 bg-priority-p1/12 border border-priority-p1/25">
              <AlertCircle className="h-3.5 w-3.5 shrink-0" strokeWidth={2.5} />
              {formatDueDate(dueDate)}
            </span>
          ) : isDueToday ? (
            <span
              className="shrink-0 mx-2 inline-flex items-center gap-1.5 px-0.75 py-0.5 rounded-lg text-[11.5px] font-semibold"
