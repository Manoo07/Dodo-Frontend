      ...
      >
        ...
        {dueDate && (
          isCompleted || isWontDo ? (
            ...
            <span className="shrink-0 mx-1 inline-flex items-center gap-1.5 px-2 py-1 rounded-lg text-[11.5px] font-semibold text-priority-p1 bg-priority-p1/12 border border-priority-p1/25">
              <AlertCircle className="h-3.5 w-3.5 shrink-0" strokeWidth={2.5} />
              {formatDueDate(dueDate)}
            </span>
          ) : isDueToday ? (
            <span
              className="shrink-0 mx-1 inline-flex items-center gap-1.5 px-2 py-1 rounded-lg text-[11.5px] font-semibold"
